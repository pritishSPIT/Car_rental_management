...
public class LoginSrv extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user.toLowerCase().equals("login as admin")){
		...
		else if(user.toLowerCase().equals("login as customer")){
			//Vendor Login Check
			...
			try {
				...
				if(rs.next()){ //Vendor Login Successful
					...
					String vid = uname;
					String pass = pword;
					String vname = rs.getString("customer_name");
					String vemail= rs.getString("customer_email");
					String vaddr = rs.getString("customer_address");
					String mob = rs.getString("customer_phone");
					VendorBean vendor = new VendorBean(vid,vname,mob,vemail,vaddr,pass);
					...
					ps = conn.prepareStatement("select * from customer where customer_email=? and password=?");
					...
					if(rs1.next()){
						...
						String vid = rs1.getString("customer_id");
						String pass = pword;
						String vname = rs1.getString("customer_name");
						String vemail= rs1.getString("customer_email");
						String vaddr = rs1.getString("customer_address");
						String mob = rs1.getString("customer_phone");
						VendorBean vendor = new VendorBean(vid,vname,mob,vemail,vaddr,pass);
