...
<body>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
        ...
        &nbsp; <span id="pagetitle">Customer Registration</span></h4><!-- pagetitle id is given here -->
      ...
      <table class="tab hd brown">
		<tr>
			<td style="color:brown">New customer? Register here.</td>
		</tr>
	</table>
	...
	<table class="tab hd blue" border="0px" cellpadding="10" cellspacing="10">
		...
		<tr>
			<td>
				...
				<br>
					Name: <input type="text" name="vname" required="required"><br/><br/>
