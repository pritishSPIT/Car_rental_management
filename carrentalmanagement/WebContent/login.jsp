	...
	<table class="tab hd blue" border="0px" cellpadding="10" cellspacing="10">
		...
		<tr>
			<td>
				...
				<br>
					Username: &nbsp; <input type="text" placeholder="Enter Email or CustID" name="username" required="required" style="color:black;font-size:19px;"><br/><br/>
					Password: &nbsp; <input type="password" name="password" required="required" style="color:black;font-size:19px;"><br/><br/>
					<input type="submit" value="Login As Customer" name="user">&nbsp; &nbsp; &nbsp; &nbsp;
